...
class Conversation:
    ...
    def get_llava_response_prompt(self, dataset_name):
        if dataset_name in ["mme", "pope"]:
            return "Answer the question using a single word or phrase."
        elif dataset_name in ["scienceqa", "mmbench", "seedbench"]:
            return "Answer with the option’s letter from the given choices directly."
        elif dataset_name in ["llavabench", "llava-qa90", "mmvp", "realworldqa", "coco-chair/val2014", "mmhalbench"]:
            return ""
