...
import torch
from models.llava_yi.model.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, key_info
...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        self, input_ids, attention_mask, past_key_values, labels, images, instead_pixel_values = None, input_dict = None,
    ):
        ...
        if instead_pixel_values is not None:
            image_features = self.get_model().embed_tokens(instead_pixel_values)
        new_input_embeds = []
