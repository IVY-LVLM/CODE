...
def get_class_in_module(class_name: str, module_path: Union[str, os.PathLike]) -> typing.Type:
    ...
    module_path = str(Path(os.path.join(os.getcwd(), 'huggingface_file/modules')) / module_path)
    original_module_path = module_path
    module_path =  os.path.abspath(f"./huggingface_file{'/'.join(module_path.split('huggingface')[1].split('/')[:-2] + module_path.split('huggingface')[1].split('/')[-1:])}")
...
def get_cached_module_file(
    ...
    **deprecated_kwargs,
    ...
    submodule_path = Path(os.path.join(os.getcwd(), 'huggingface_file/modules')) / full_submodule
